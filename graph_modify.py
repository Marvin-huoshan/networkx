...
def multi_process(G,file,name):
    ...
    p.apply_async(read_class, args=(G, mySheet1,name))
    p.apply_async(read_class, args=(G, mySheet2,name))
    p.apply_async(read_class, args=(G, mySheet3,name))
    p.apply_async(read_class, args=(G, mySheet4,name))
    p.close()
    p.join()
