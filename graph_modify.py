...
if __name__ == '__main__':
    ...
    G_kar_OED = nx.read_edgelist('kar-origin-sheet1.edglist')
    G_kar_OED_unfrozen = nx.read_edgelist('kar-unfrozen-sheet1.edglist')
    G_1_OED = nx.read_edgelist('1-origin-origin-sheet1.edglist')
    G_1_OED_unfrozen = nx.read_edgelist('1-un-un-sheet1.edglist')
    test_frozen('G_1','G_1_OED','G_1_OED_unfrozen',G_1,G_1_OED,G_1_OED_unfrozen)
